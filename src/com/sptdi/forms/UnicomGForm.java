...
public class UnicomGForm {
public static void UGForm(String str) {    
    ...
    try {
       ...
       // sql = "select * from unicominfo where license = '310020110005/C0382'";
        ...
        String[] datestr = network1startdate.trim().split(" ");//[1];//.split("-");
        ...
        String[] angles  = network1angle.split(",");
        ...
        wdata.put("receiveangle1",network1receiveangle);
        wdata.put("receiveangle2",network1receiveangle);
        wdata.put("receiveangle3",network1receiveangle);
        wdata.put("sendangle1",network1sendangle);
        wdata.put("sendangle2",network1sendangle);
        wdata.put("sendangle3",network1sendangle);
        
        String[] network1sendfreqs = network1sendfreq.split("-");
        
        wdata.put("sendstartfreq1",network1sendfreqs[0]);
        wdata.put("sendstartfreq2",network1sendfreqs[0]);
        wdata.put("sendstartfreq3",network1sendfreqs[0]);
        wdata.put("sendendfreq1",network1sendfreqs[1]);
        wdata.put("sendendfreq2",network1sendfreqs[1]);
        wdata.put("sendendfreq3",network1sendfreqs[1]);
        
        String[] network1receivefreqs = network1receivefreq.split("-");
        wdata.put("receivestartfreq1",network1receivefreqs[0]);
        wdata.put("receivestartfreq2",network1receivefreqs[0]);
        wdata.put("receivestartfreq3",network1receivefreqs[0]);
        wdata.put("receiveendfreq1",network1receivefreqs[1]);
        wdata.put("receiveendfreq2",network1receivefreqs[1]);
        wdata.put("receiveendfreq3",network1receivefreqs[1]);
        
        
        wdata.put("cmiitid1",network1cmiitid.split(":")[1]);
        wdata.put("equipmentmodel1",network1equipmentmodel);
        wdata.put("equipmentnum1",network1equipmentnum);
        
        if(network1equipmentfactory.trim()==null||network1equipmentfactory.trim().length()==0){
        	network1equipmentfactory = "/";
        }
        wdata.put("equipmentfactory1",network1equipmentfactory);
                   
        wdata.put("transmitpower1",network1transmitpower);
        wdata.put("cmiitid2",network1cmiitid.split(":")[1]);
        wdata.put("equipmentmodel2",network1equipmentmodel);
        wdata.put("equipmentnum2",network1equipmentnum);
        wdata.put("equipmentfactory2",network1equipmentfactory);
        wdata.put("transmitpower2",network1transmitpower);
        wdata.put("cmiitid3",network1cmiitid.split(":")[1]);
        wdata.put("equipmentmodel3",network1equipmentmodel);
        wdata.put("equipmentnum3",network1equipmentnum);
        wdata.put("equipmentfactory3",network1equipmentfactory);
        wdata.put("transmitpower3",network1transmitpower);
        wdata.put("sector11","1");
        wdata.put("antennatype1",network1antennatype);
        wdata.put("antennamodel1",network1antennamodel);
        wdata.put("polarization1",network1polarization);
        wdata.put("angle3db1",network13db);
        wdata.put("dbi1",network1dbi);
        wdata.put("antennafactory1",network1antennafactory);
        wdata.put("antennahigh1",network1antennahigh);
        wdata.put("loss1",network1loss);
        wdata.put("sector22","2");
        wdata.put("antennatype2",network1antennatype);
        wdata.put("antennamodel2",network1antennamodel);
        wdata.put("polarization2",network1polarization);
        wdata.put("angle3db2",network13db);
        wdata.put("dbi2",network1dbi);
        wdata.put("antennafactory2",network1antennafactory);
        wdata.put("antennahigh2",network1antennahigh);
        wdata.put("loss2",network1loss);
        wdata.put("sector33","3");
        wdata.put("antennatype3",network1antennatype);
        wdata.put("antennamodel3",network1antennamodel);
        wdata.put("polarization3",network1polarization);
        wdata.put("angle3db3",network13db);
        wdata.put("dbi3",network1dbi);
        wdata.put("antennafactory3",network1antennafactory);
        wdata.put("antennahigh3",network1antennahigh);
        wdata.put("loss3",network1loss);
        ...
        Writer out = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(new File("D:\\upload\\联通G网报表.doc")),"utf-8"));//����ļ������ 
