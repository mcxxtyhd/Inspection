...
public class UnicomDForm {
public static void UDForm(String str) {   
    ...
    try {
        ...
        String[] datestr = network2startdate.trim().split(" ");//[1];//.split("-");
        String[] datestr2 = datestr[0].split("-");
        String newdate = datestr2[0] + " 年" + datestr2[1] + " 月" + datestr2[2] + " 日" ;
        
        wdata.put("startdate",newdate);//startdate);
        wdata.put("sector1","1");
        wdata.put("sector2","2");
        wdata.put("sector3","3");
        
        String[] angles  = network2angle.split(",");
        wdata.put("angle1",angles[0]);
        wdata.put("angle2",angles[1]);
        wdata.put("angle3",angles[2]);
        
        String[] sectorificationcodes  = network2identificationcode.split(",");
        ...
        wdata.put("receiveangle1",network2receiveangle);
        wdata.put("receiveangle2",network2receiveangle);
        wdata.put("receiveangle3",network2receiveangle);
        wdata.put("sendangle1",network2sendangle);
        wdata.put("sendangle2",network2sendangle);
        wdata.put("sendangle3",network2sendangle);
        
        String[] network2sendfreqs = network2sendfreq.split("-");
        
        wdata.put("sendstartfreq1",network2sendfreqs[0]);
        wdata.put("sendstartfreq2",network2sendfreqs[0]);
        wdata.put("sendstartfreq3",network2sendfreqs[0]);
        wdata.put("sendendfreq1",network2sendfreqs[1]);
        wdata.put("sendendfreq2",network2sendfreqs[1]);
        wdata.put("sendendfreq3",network2sendfreqs[1]);
        
        String[] network2receivefreqs = network2receivefreq.split("-");
        wdata.put("receivestartfreq1",network2receivefreqs[0]);
        wdata.put("receivestartfreq2",network2receivefreqs[0]);
        wdata.put("receivestartfreq3",network2receivefreqs[0]);
        wdata.put("receiveendfreq1",network2receivefreqs[1]);
        wdata.put("receiveendfreq2",network2receivefreqs[1]);
        wdata.put("receiveendfreq3",network2receivefreqs[1]);
        
        
        wdata.put("cmiitid1",network2cmiitid.split(":")[1]);
        wdata.put("equipmentmodel1",network2equipmentmodel);
        wdata.put("equipmentnum1",network2equipmentnum);
        
        if(network2equipmentfactory.trim()==null||network2equipmentfactory.trim().length()==0){
        	network2equipmentfactory = "/";
        }
        wdata.put("equipmentfactory1",network2equipmentfactory);
                   
        wdata.put("transmitpower1",network2transmitpower);
        wdata.put("cmiitid2",network2cmiitid.split(":")[1]);
        wdata.put("equipmentmodel2",network2equipmentmodel);
        wdata.put("equipmentnum2",network2equipmentnum);
        wdata.put("equipmentfactory2",network2equipmentfactory);
        wdata.put("transmitpower2",network2transmitpower);
        wdata.put("cmiitid3",network2cmiitid.split(":")[1]);
        wdata.put("equipmentmodel3",network2equipmentmodel);
        wdata.put("equipmentnum3",network2equipmentnum);
        wdata.put("equipmentfactory3",network2equipmentfactory);
        wdata.put("transmitpower3",network2transmitpower);
        wdata.put("sector11","1");
        wdata.put("antennatype1",network2antennatype);
        wdata.put("antennamodel1",network2antennamodel);
        wdata.put("polarization1",network2polarization);
        wdata.put("angle3db1",network23db);
        wdata.put("dbi1",network2dbi);
        wdata.put("antennafactory1",network2antennafactory);
        wdata.put("antennahigh1",network2antennahigh);
        wdata.put("loss1",network2loss);
        wdata.put("sector22","2");
        wdata.put("antennatype2",network2antennatype);
        wdata.put("antennamodel2",network2antennamodel);
        wdata.put("polarization2",network2polarization);
        wdata.put("angle3db2",network23db);
        wdata.put("dbi2",network2dbi);
        wdata.put("antennafactory2",network2antennafactory);
        wdata.put("antennahigh2",network2antennahigh);
        wdata.put("loss2",network2loss);
        wdata.put("sector33","3");
        wdata.put("antennatype3",network2antennatype);
        wdata.put("antennamodel3",network2antennamodel);
        wdata.put("polarization3",network2polarization);
        wdata.put("angle3db3",network23db);
        wdata.put("dbi3",network2dbi);
        wdata.put("antennafactory3",network2antennafactory);
        wdata.put("antennahigh3",network2antennahigh);
        wdata.put("loss3",network2loss);
        ...
        Writer out = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(new File("D:\\upload\\联通D网报表.doc")),"utf-8"));//����ļ������ 
