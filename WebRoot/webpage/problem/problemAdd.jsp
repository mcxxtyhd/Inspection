	        ...
	        <table width="450px" height="330px" class="tableForm" >
			   <tr>
				...
				<tr>
					...
					<td><input name="prositenum" id="prositenum" style="width:220px;height:20px;"class="easyui-validatebox" required="true" missingMessage="设备编号不能为空!"/><font color="red">*</font></td>
				</tr>
				<tr>
				...
				<tr>
				    <th>维护队：</th>
				  <td>  <select name="iuserid" style="width:220px;height:20px;" class="easyui-validatebox" required="true" missingMessage="维护队不能为空!">
					        <option value="">请选择</option>
					...
					<td><input name="ternumber" style="width:220px;height:20px;"  class="easyui-validatebox" required="true" missingMessage="终端编号不能为空!"/><font color="red">*</font></td>
				</tr>
				<tr>
