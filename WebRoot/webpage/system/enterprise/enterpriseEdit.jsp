	 ...
	 <input name="id" type="hidden" />
			<table width="400px" height="220px" class="tableForm" >
				<tr>
					...
					<td><input name="entname" class="easyui-validatebox" required="true" missingMessage="名称不能为空!"  style="width:220px;height:20px;"/><font color="red">*</font></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
					   <textarea name="entdesc" style="height: 90px;width:320px;"></textarea>
					</td>
				</tr>
			</table>
	</form>
