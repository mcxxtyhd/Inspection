...
<div style="padding: 5px;overflow: hidden;">
	<form id="userForm" method="post">
	        <table width="400px" height="320px" class="tableForm" >
				<tr>
					<th align="right">用户名称：</th>
					<td><input name="username" class="easyui-validatebox" required="true" missingMessage="用户名称不能为空!"  style="width:220px;height:20px;"/><font color="red">*</font></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><input type="password" name="password" class="easyui-validatebox" required="true" missingMessage="密码不能为空!"  style="width:220px;height:20px;"/><font color="red">*</font></td>
				</tr>
				<tr>
					<th align="right">重复密码：</th>
					<td><input type="password" name="checkpassword" class="easyui-validatebox"  style="width:220px;height:20px;"
					data-options="required:'true',missingMessage:'请再次填写密码',validType:'eqPassword[\'#userForm input[name=password]\']'" /><font color="red">*</font>
					</td>
				</tr>
				<tr>
