		 ...
		 <input name="id" type="hidden" />
	        <table width="500px" height="250px" class="tableForm" >
				<tr>
					...
					<td><input name="termno" class="easyui-validatebox" readonly="readonly" required="true" missingMessage="编号不能为空!"  style="width:220px;height:20px;"/><font color="red">*</font></td>
				</tr>
				<tr>
