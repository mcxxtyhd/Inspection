	...
	<form id="projectForm" method="post">
			<table width="420px" height="220px" class="tableForm" >
				...
				<tr>
					...
					<td><input name="pname" class="easyui-validatebox" required="true" missingMessage="小类名称不能为空!"  style="width:220px;height:20px;"/><font color="red">*</font></td>
				</tr>
				<tr>
				...
				<tr id="tr1">
				 ...
				 <td>
				    <select name="penumvalue" id="penumvalue" style="width:220px;height:20px;">
				        <option value="">请选择</option>
