	...
	<form id="inspectuserForm" method="post">
			<table width="400px" height="270px" class="tableForm" >
				<tr>
					...
					<td><input name="iuname" class="easyui-validatebox" required="true" missingMessage="登录名称不能为空!" style="width:220px;height:20px;"/><font color="red">*</font></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><input type="password" name="riupwd" class="easyui-validatebox" required="true" missingMessage="重复密码不能为空!" style="width:220px;height:20px;"
					data-options="required:'true',missingMessage:'请再次填写密码',validType:'eqPassword[\'#inspectuserForm input[name=iupwd]\']'" /><font color="red">*</font></td>
				</tr>
				<tr>
