...
<script language="javascript">
    ...
    function isSelected(id,value){
	   ...
	   for(var i=0;i<len;i++){
	  	  if(obj.options[i].text == value || obj.options[i].value == value){
...
<div style="padding: 5px;overflow: hidden;">
	<form id="lineForm" method="post">
	 <input name="id" type="hidden" />
			<table width="800px" height="50px" class="tableForm" >
				<tr>	
			...
			<tr>	
				...
				style="width:150px;height:300px;margin-left:20px;float:left">
				   <c:forEach items="${LineSelectPointList}" var="pointsl">
				  	 <option value='<c:out value="${pointsl.id}"/>'><c:out value="${pointsl.poname}"/></option>
				   </c:forEach>
				</select>
			</td>
		   </tr>
