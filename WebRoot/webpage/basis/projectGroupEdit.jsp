...
<div style="padding: 5px;overflow: hidden;">
	...
	<table width="400px" height="130px" class="tableForm" >
			<tr>
					...
					<td><input name="pgname"  readonly="readonly" style="width:220px;height:20px;"class="easyui-validatebox" required="true" missingMessage="巡检项大类名称不能为空!"/><font color="red">*</font></td>
				</tr>
				<tr>
